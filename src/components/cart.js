    ...
    renderCart(){
                    ...
                    <Row>
                        ...
                        <Col xs={6} sm={4}>
                            <ButtonGroup style={{minWidth:'300px'}}>
                                ...
                                <Button onClick={this.onImcrement.bind(this, cartArr._id)} bsStyle="default" bsSize="small">+</Button>
                                <span>    </span>
        ...
        return (
            <Panel header="Cart" bsStyle="primary">
                ...
                <Row>
                    <Col xs={12}>
                        <h6>Total amoutn: {this.props.totalAmount}</h6>
          ...
          <Modal.Header closeButton>
            <Modal.Title>Thank your !</Modal.Title>
          </Modal.Header>
          <Modal.Body>
